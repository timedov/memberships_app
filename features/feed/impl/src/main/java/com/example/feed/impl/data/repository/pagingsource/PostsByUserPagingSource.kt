...
internal class PostsByUserPagingSource(
    ...
    override suspend fun load(
        ...
        return try {
            ...
            val posts = postDataSource.getPostsByAuthor(
                authorName = username,
                limit = params.loadSize,
                startAfter = nextKey.first,
                startAfterId = nextKey.second
            )
    ...
    override fun getRefreshKey(state: PagingState<Pair<Long, String>, PostDataModel>): Pair<Long, String>? {
